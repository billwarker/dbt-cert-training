-- Removes table and views from the given run configuration
-- To use in production: dbt run-operation cleanup_dataset
-- To only see commands that it is about to perform: dbt run-operation --args '{"dry_run": True}'

{% macro cleanup_dataset(dry_run=True) %}
